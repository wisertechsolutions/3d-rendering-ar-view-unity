...
/// 
/// More info in my blog post about singletons: https://www.patrykgalach.com/2019/04/04/singleton-in-unity-love-or-hate/ 
/// </summary>
public class PersistentLazySingleton<T> : MonoBehaviour where T : MonoBehaviour
{
    ...
    public static T Instance
    {
        get
        {
            ...
            ) // If game is closing and we already destroyed instance, we shouldn't create new one!
            {
